...
const mainCardType = document.getElementById('book-genre')
const mainCardName = document.getElementById('book-title')
const mainCardComments = document.getElementById('book-comments')
const mainCardAddress = document.getElementById('book-author')
const mainCardURL = document.getElementById('url')
const mainCard = document.getElementById('Main-Book')
...
search.addEventListener('submit', (e) => {
    ...
    .then(res => res.json())
    .then(data => data.forEach(bookBuilder))
